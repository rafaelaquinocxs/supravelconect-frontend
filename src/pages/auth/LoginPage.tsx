...
const LoginPage: React.FC = () => {
  ...
  const handleFacebookLogin = () => {
    ...
    toast.info('Login com Facebook em desenvolvimento');
  };
    ...
    <div className="min-h-screen bg-gray-900 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full space-y-8">
        ...
        <div className="text-center">
          ...
          <p className="mt-2 text-gray-400">Conectando especialistas</p>
        </div>
        ...
        <div className="bg-gray-800 rounded-lg shadow-xl p-8 border border-gray-700">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-primary-500 hover:bg-primary-600 disabled:bg-gray-600 text-white font-semibold py-3 px-4 rounded-lg transition-colors focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2 focus:ring-offset-gray-800"
            >
              {loading ? (
